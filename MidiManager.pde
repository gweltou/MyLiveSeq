...
public class Pattern {
    ...
    public void setLength(int nBeats) {
        this.nBeats = nBeats;
    }
    ...
    public int getRepeat() { return nRepeat; }

    public ArrayList<MidiEvent> getEvents() { return midiEvents; }

    public void addEvent(MidiEvent event) { midiEvents.add(event); }

    public void addNote(MidiNote note) { midiNotes.add(note); }
...
public class MidiManager extends Thread {
    ...
    public MidiDevice getInputDevice() { return inputDevice; }
    public MidiDevice getOutputDevice() { return outputDevice; }
    ...
    public long getPatternTime() { return localTicks-patternStartTime; }
